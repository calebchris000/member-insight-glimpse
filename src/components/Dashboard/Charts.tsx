...
import { generateDailyStats, generatePageVisitStats, DailyStat, PageVisit } from '@/utils/mockData';
...
const Charts: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setPageVisits(generatePageVisitStats());
  ...
  // Calculate active users by hour (mock data)
  const getActiveUsersByHour = () => {
    const hours = [];
    const now = new Date();
