...
// Mock users
const users: User[] = [
  { id: '1', name: 'John Smith', avatar: 'JS', email: 'john@example.com', role: 'admin' },
  { id: '2', name: 'Sarah Johnson', avatar: 'SJ', email: 'sarah@example.com', role: 'member' },
  { id: '3', name: 'Michael Brown', avatar: 'MB', email: 'michael@example.com', role: 'member' },
  { id: '4', name: 'Emily Davis', avatar: 'ED', email: 'emily@example.com', role: 'member' },
  { id: '5', name: 'Daniel Wilson', avatar: 'DW', email: 'daniel@example.com', role: 'member' },
  { id: '6', name: 'Lisa Moore', avatar: 'LM', email: 'lisa@example.com', role: 'member' },
  { id: '7', name: 'Robert Taylor', avatar: 'RT', email: 'robert@example.com', role: 'member' },
  { id: '8', name: 'Jessica White', avatar: 'JW', email: 'jessica@example.com', role: 'member' },
];
...
// Generate page visit statistics
...
// Generate current statistics for the dashboard
